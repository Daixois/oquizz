...
class AppFixtures extends Fixture
{
	...
	//     $manager->persist($parentTheme);
		...
		$manager->flush();
                ...
                $quizzAnnées8090->setImage("annees8090-1.jpg");
                ...
                $quizzNostalgie8090->addTheme($Années8090)->addTheme($parentTheme)->setCreatedBy($corentinUser);
                ...
                $quizzCinéma2->setImage("cinéma.jpg");
                $quizzCinéma2->addTheme($cinéma)->addTheme($movietheme)->setCreatedBy($tomUser);
